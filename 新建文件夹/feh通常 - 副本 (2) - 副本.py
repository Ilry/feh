...
STEP_CONFIG = {
    1: {
        "desc": "选择难度",
        "target": Template(r"tpl1744794482639.png", record_pos=(0.023, -0.072), resolution=(900, 1600)),
        "next_step": 2,  # 预期下一步
    ...
    2: {
        "desc": "开始战斗",
        "target": Template(r"tpl1744793029710.png", record_pos=(-0.007, 0.204), resolution=(900, 1600)),
        "next_step": 3,
    ...
    3: {
        "desc": "跳过战斗",
        "target": Template(r"tpl1744793077506.png", record_pos=(0.33, -0.82), resolution=(900, 1600)),
        "next_step": 4,
        "operation_timeout": 30,
        "wait_timeout": 15
    },
    4: {
        "desc": "自动战斗",
        "target": Template(r"tpl1744794010886.png", record_pos=(0.267, 0.808), resolution=(900, 1600)),
        "until": Template(r"tpl1744793270290.png", record_pos=(0.012, 0.0), resolution=(900, 1600)),
        "next_step": 5,
    ...
    5: {
        "desc": "开始关卡",
        "target": Template(r"tpl1744793293162.png", record_pos=(0.002, -0.023), resolution=(900, 1600)),
        "next_step": 6,
        "operation_timeout": 30,
        "wait_timeout": 15
    },
    6: {
        "desc": "结束战斗",
        "target": Template(r"tpl1744793326689.png", record_pos=(-0.004, 0.02), resolution=(900, 1600)),
        "next_step": 1,
        "operation_timeout": 30,
        "wait_timeout": 15
    },
