...
def perform_battle_operations():
    ...
    if  wait(Template(r"tpl1745395584291.png", record_pos=(0.047, -0.066), resolution=(900, 1600))):
        touch(Template(r"tpl1745395584291.png", record_pos=(0.047, -0.066), resolution=(900, 1600)))
...
#             sleep()
    ...
    if wait(Template(r".\pic\tpl1744793077506.png", record_pos=(0.33, -0.82), resolution=(900, 1600))):
#             sleep()
