...
def perform_battle_operations():
    ...
    while 1:
        try:
            pos = wait(Template(r".\pic\tpl1744794482639.png", record_pos=(0.023, -0.072), resolution=(900, 1600)))
#             sleep()
            touch(pos)
            print("选择难度"+'\n')
            break
    ...
    while 1:
        try:
            pos = wait(Template(r".\pic\tpl1744793077506.png", record_pos=(0.33, -0.82), resolution=(900, 1600)))
    #             sleep()
            touch(pos)
            print("跳过"+'\n')
            break
...
#     while not exists(Template(r".\pic\tpl1744793270290.png", record_pos=(0.012, 0.0), resolution=(900, 1600))):
#         time.sleep(0.1)
#     if wait(Template(r".\pic\tpl1744793270290.png", record_pos=(0.012, 0.0), resolution=(900, 1600))):
    while 1:
        try:
            pos = wait(Template(r".\pic\tpl1744793293162.png", record_pos=(0.002, -0.023), resolution=(900, 1600)))
        #             sleep()
            touch(pos)
            print("开始"+'\n')
            break
    ...
    while 1:
        try:
            ...
            pos = wait(Template(r".\pic\tpl1744793326689.png", record_pos=(-0.004, 0.02), resolution=(900, 1600)))
    #             sleep()
