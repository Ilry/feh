...
def perform_battle_operations():
    ...
    tag2 = True
    while 1:
        if  exists(Template(r"tpl1745395584291.png", record_pos=(0.047, -0.066), resolution=(900, 1600))):
            touch(Template(r"tpl1745395600267.png", record_pos=(0.038, -0.071), resolution=(900, 1600)))



            break
        elif exists(Template(r".\pic\tpl1744793326689.png", record_pos=(-0.004, 0.02), resolution=(900, 1600))):
            touch(Template(r".\pic\tpl1744793326689.png", record_pos=(-0.004, 0.02), resolution=(900, 1600)))
            break
        elif exists(Template(r"tpl1745384304553.png", record_pos=(-0.002, 0.004), resolution=(900, 1600))):
            touch(Template(r"tpl1745384323345.png", record_pos=(0.004, 0.039), resolution=(900, 1600)))
            break
...
#             sleep()
    ...
    # 共同操作流程（完全保持原始参数）
    while not exists(Template(r".\pic\tpl1744897278330.png", record_pos=(0.007, 0.208), resolution=(900, 1600))):
         sleep()
#     pos = wait(Template(r".\pic\tpl1744897278330.png", record_pos=(0.007, 0.208), resolution=(900, 1600)))
#             sleep()
    ...
    while tag1:
        if exists(Template(r"tpl1745384304553.png", record_pos=(-0.002, 0.004), resolution=(900, 1600))):
            touch(Template(r"tpl1745384323345.png", record_pos=(0.004, 0.039), resolution=(900, 1600)))
        elif (exists(Template(r".\pic\tpl1744793077506.png", record_pos=(0.33, -0.82), resolution=(900, 1600))) and (not exists(Template(r"tpl1745384304553.png", record_pos=(-0.002, 0.004), resolution=(900, 1600))))):
#             sleep()
