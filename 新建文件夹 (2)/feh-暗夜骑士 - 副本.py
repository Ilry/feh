...
def perform_battle_operations():
    ...
    # tag3 = True
    while tag[0]:
        pos[0] = exists(Template(r"tpl1745823861385.png", record_pos=(0.0, 0.01), resolution=(900, 1600)))

        pos[1] = exists(Template(r".\pic\结束战斗.png", record_pos=(-0.004, 0.02), resolution=(900, 1600)))
        if pos[0]:
            touch(pos[0])
...
#             sleep()
    ...
    while tag[1]:
        ...
        pos[3] = exists(Template(r".\pic\开始战斗.png", record_pos=(0.007, 0.208), resolution=(900, 1600)))
        if pos[3]:
            touch(pos[3])
            tag[1] = False
        else:
    ...
    while tag[2]:
        pos[3] = exists(Template(r".\pic\开始战斗.png", record_pos=(0.007, 0.208), resolution=(900, 1600)))
        pos[4] = exists(Template(r".\pic\跳过.png", record_pos=(0.33, -0.82), resolution=(900, 1600)))
        if pos[4]:
            touch(pos[4])
            tag[2] = False
        elif pos[3]:
    ...
    while tag[3]:
        pos[5] = exists(Template(r".\pic\自动战斗菜单.png", record_pos=(0.012, 0.0), resolution=(900, 1600)))
        pos[6] = exists(Template(r".\pic\自动战斗.png", record_pos=(0.267, 0.808), resolution=(900, 1600)))
        pos[7] = exists(Template(r".\pic\开始自动战斗.png", record_pos=(0.002, -0.023), resolution=(900, 1600)))
    ...
    print("等待中",end="")
    while tag[4]:
        pos[8] = exists(Template(r".\pic\结束战斗.png", record_pos=(-0.004, 0.02), resolution=(900, 1600)))
        if not pos[8]:
            print("…………",end="")
            times[4] += 1
        else:
